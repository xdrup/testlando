...
(function ($) {
  Drupal.behaviors.testbehavior = {
    ...
    //  $(context).find('.views-exposed-form').once().append('<p>Test</p>');
     // $('.views-exposed-form').append('<p>Test</p>');
      $('.views-exposed-form', context).once('myCustomBehavior').once().append('<p>Test</p>');
